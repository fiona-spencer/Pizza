...
const Map = () => {
  return (
    <section className="w-full px-4 py-12 bg-[#312f2f] text-white ">
      {/* Title & Subtitle */}
      ...
      <div className="sm:flex sm:grid-flow-col mx-auto sm:px-48 sm:gap-9 items-center">

      {/* Info Section */}
      <div className="my-6 max-w-3xl mx-auto text-center bg-[#d95a5a] p-4 sm:p-10 border-2 border-white rounded sm:flex-1 text-sm sm:text-base">
