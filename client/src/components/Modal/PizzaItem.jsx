  ...
  return (
    <>
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="relative" // container must be relative for absolute positioning
      >
        {index < 2 && (
         <motion.div
       ...
       >
        ...
        <div className="p-3 pb-1 sm:p-4 md:p-5 bg-white rounded-md flex flex-col lg:flex-col shadow-xl">
